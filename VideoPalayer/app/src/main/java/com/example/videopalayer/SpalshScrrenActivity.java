package com.example.videopalayer;
...
public class SpalshScrrenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_spalsh_scrren);
                ...
                if (shouldshowRationals) {
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    dialog.dismiss();
                                    Toast.makeText(getApplicationContext(), "Please Click On Yes And Allow Allow All Permission To Access All Files", Toast.LENGTH_SHORT).show();
                                }
                            }).show();
                } else {
                    activityResultLauncher.launch(permissionsArray);
