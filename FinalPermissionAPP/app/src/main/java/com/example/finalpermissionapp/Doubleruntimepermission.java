...
public class Doubleruntimepermission extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doubleruntimepermission);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (Cheackpermission()) {
                    Toast.makeText(Doubleruntimepermission.this, "PERMISSION ALREADY GRANTED !", Toast.LENGTH_SHORT).show();
                } else {
                    ActivityCompat.requestPermissions(Doubleruntimepermission.this, new String[]{ACCESS_FINE_LOCATION, READ_SMS}, REQ_CODE);
                }
